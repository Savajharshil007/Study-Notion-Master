...
## Live Project Links
[https://study-notion-master-six.vercel.app](https://study-notion-master-six.vercel.app)
...
1. Clone the repository to your local machine.
    ```sh
    git clone [https://github.com/Savajharshil007/Study-Notion-Master.git](https://github.com/Savajharshil007/Study-Notion-Master.git)
    ```
...
5. Open the project in your browser at [`http://localhost:3000`](http://localhost:3000) to view your local setup.
